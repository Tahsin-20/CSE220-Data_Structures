...
public class AdjList {
    ...
    public static void addEdge(Edge[]adjList, int src, int dest){
        addSingleEdge(adjList, src, dest);
        addSingleEdge(adjList, dest, src);
    }
    public static void addSingleEdge(Edge[]adjlist, int src, int dest){
    ...
    public static int Degree(Edge[]adjList){
        int maxcount=0;
        int vertex=-1;
        for(int i=0; i<adjList.length; i++){
            int nodecount=0;
    ...
    public static void main(String[]args){
        ...
        System.out.println(Degree(adjList));
    }
}
